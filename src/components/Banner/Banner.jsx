...
export default function Banner({ onSearch, onPlaceAnAd }) {
    ...
    const isFilterApplied = city || locations.length > 0 || propertyType || priceMin || priceMax || beds || baths || agentType || status || purpose;
    ...
    const handleSaleClick = () => {
        ...
        // Trigger search with purpose 'Sale'
        onSearch({ 
            city: "",
            location: "",
            propertyType: "",
    ...
    const handleRentClick = () => {
        setPurpose("Rent"); // Fixed: Changed from "buy" to "Rent"
        // Clear other filters
        setCity("");
        setLocations([]);
        setPropertyType("");
        ...
        // Trigger search with purpose 'Rent'
        onSearch({ 
            city: "",
            location: "",
            propertyType: "",
    ...
    const handleOffPlanClick = () => {
        ...
        // Trigger search with status 'false'
        onSearch({ 
            city: "",
            location: "",
            propertyType: "",
    ...
    // Handle input change and trigger search for select elements
                        ...
                        <div className="lg:block lg:contents space-y-4 lg:space-y-0">
                            ...
                            <div className="flex flex-col w-full">
                                ...
                                <select
                                    name="propertyType"
                                    value={propertyType}
                                    onChange={(e) => handleSelectChange(setPropertyType, e.target.value)}
                                    className="p-2 h-10 rounded-md border border-primary text-sm text-primary w-full"
                                >
                                    <option value="">Any</option>
                            ...
                            <div className="flex flex-row gap-4 w-full lg:col-span-2">
                                ...
                                <div className="flex flex-col w-1/2">
                                    ...
                                    <select
                                        name="beds"
                                        value={beds}
                                        onChange={(e) => handleSelectChange(setBeds, e.target.value)}
                                        className="p-2 h-10 rounded-md border border-primary text-sm text-primary w-full"
                                    >
                                ...
                                <div className="flex flex-col w-1/2">
                                    ...
                                    <select
                                        name="baths"
                                        value={baths}
                                        onChange={(e) => handleSelectChange(setBaths, e.target.value)}
                                        className="p-2 h-10 rounded-md border border-primary text-sm text-primary w-full"
                                    >
